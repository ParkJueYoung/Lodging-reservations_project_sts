...
<meta charset="UTF-8">
<title>숙박 예약</title>
<link rel="stylesheet" href="resources/css/search.css?abcd">
				...
				<c:if test="${listcheck != 'empty'}">
					<div class="search_filter">
						<div class="filter_button_wrap">
							<button class="filter_button filter_active" id="filter_button_a">카라반</button>
							<button class="filter_button" id="filter_button_b">캠핑장</button>
						</div>
									...
									<tr>
										<td class="image">
											<div class="image_wrap"
												data-lodgingid="${list.imageList[0].lodgingId}"
										...
										<td class="detail">
											...
											<div class="title">
											<a href="/lodgingDetail/${list.lodgingId}">
												${list.lodgingName}
											</a>
											</div>
											<div class="lease">
										...
										<td class="price">
											<div class="org_price">${list.lodgingPrice }</div>
										</td>
										<td class="option"></td>
									</tr>
								</c:forEach>
		...
		$(document).ready(function() {
			...
			$(".image_wrap").each(function(i, obj) {
				...
				if (bobj.data("lodgingid")) {
					...
					} else {$(this).find("img").attr('src','/resources/img/lodgingNoImage.png');
						}
			});
